...
public class PeanutRecipeProvider extends RecipeProvider {
	...
	protected void buildRecipes() {
		shaped(RecipeCategory.FOOD, ModRegistry.PEANUT_BREAD.get())
				.pattern("#P#")
				.define('#', Tags.Items.CROPS_WHEAT)
				.define('P', ModTags.CROPS_PEANUT)
				.unlockedBy("has_peanut", has(ModTags.CROPS_PEANUT)).save(this.output);
		shaped(RecipeCategory.FOOD, ModRegistry.PEANUT_BUTTER.get())
				.pattern("PMP")
				.define('M', Items.MILK_BUCKET)
				.define('P', ModTags.CROPS_PEANUT)
				.unlockedBy("has_peanut", has(ModTags.CROPS_PEANUT)).save(this.output);
		shaped(RecipeCategory.FOOD, ModRegistry.PEANUT_BUTTER_BREAD.get())
				.pattern("PB")
				.define('P', ModRegistry.PEANUT_BUTTER.get())
				.define('B', Items.BREAD)
				.unlockedBy("has_peanut", has(ModTags.CROPS_PEANUT)).save(this.output);
		shapeless(RecipeCategory.FOOD, ModRegistry.PEANUT_PIE.get())
